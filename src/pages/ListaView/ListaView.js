...
const ListaView = (props) => {
  ...
  return (
    <div className="container flex-grow-1">
      <div className="row">
        <div className="col">
          <h1 className="text-center mt-4">{lista.titulo}</h1>
          <h2 className="text-center">{lista.descricao}</h2>
          <h4 className="text-center">{lista.prioridade}</h4>
          <h4 className="text-center">{lista.status}</h4>
          <h5 className="text-center">{lista.prazo}</h5>

          <div className="btn-group mt-3 w-100 d-flex align-items-center justify-content-center">
            <Link to={`/edit/${lista._id}`}  className="btn btn-outline-info">Editar</Link>
